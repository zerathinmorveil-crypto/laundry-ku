...
<style>
    ...
    body.login-page {
        ...
        overflow: hidden;
        font-family: 'Nunito', 'Instrument Sans', sans-serif;
    }
    ...
    /* ── Footer links ── */
    .login-card-body ~ .card-footer a,
    .login-box-footer a {
        color: #0abfbc !important;
        font-weight: 600;
    }

    .login-card-body ~ .card-footer a:hover,
    ...
    /* ensure everything sits above the decorative layer */
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // ── Bubbles ──
    const bubbles = [
        { size: 18, right: '15%', bottom: '30%', duration: '3.5s', delay: '0s' },
        { size: 12, right: '80%', bottom: '25%', duration: '4.2s', delay: '1s' },
        { size: 22, right: '25%', bottom: '55%', duration: '5s',   delay: '0.5s' },
        { size: 10, right: '70%', bottom: '60%', duration: '3s',   delay: '2s' },
        { size: 16, right: '50%', bottom: '20%', duration: '4s',   delay: '1.5s' },
    ];
